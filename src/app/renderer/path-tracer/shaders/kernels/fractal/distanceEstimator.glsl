...
#pragma glslify: mandelbulbDe = require("./mandelbulbDe.glsl", Power=Power)
#pragma glslify: mengerSpongeDe = require("./mengerSpongeDe.glsl", spongeOffset=spongeOffset, spongeScale=spongeScale, halfSpongeScale=halfSpongeScale)
